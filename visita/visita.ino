...
{ if (mfrc522.PICC_IsNewCardPresent())
  ...
  if (cliente.available())
  {
    ...
    cliente.println("<h1>Facultad De Ciencias</h1>");
    ...
    cliente.println("<h1>Facultad De Ciencias</h1><br>");
    cliente.println("Ingresar visita");
    cliente.println("<form action='http://192.168.16.102/arduino/rfid_visita.php' method='POST'>");
    ...
    cliente.print("'>");
    cliente.println("<br>");
    cliente.print("<input type='hidden' name='facultad' value='ciencias'>");
    cliente.println("<button type='submit' value='Submit'>Consultar</button>");
